...
const validatePin = (pin) => {
  // Solution code here...
  let validators = /^[0-9]{4}$/;
  return validators.test(pin);
};
...
const validateWord = (word) => {
  // Solution code here...
  let validators = /^[A-z]{5,10}$/;
  return validators.test(word);
};
...
const hasNumber = (string) => {
  // Solution code here...
  let validators = /[A-z]+[0-9]+/;
  return validators.test(string);
};
...
const validateEmail = (email) => {
  // Solution code here...
  let validators = /^[A-z0-9]+.[A-z0-9]+@\w*(\.com|\.net|\.org)$/;
